...
datosProducto.forEach((producto, index) => {
    ...
    let celdaDetalles = fila.insertCell(1);
    ...
    let iconoModificar = document.createElement('a');
    iconoModificar.href = '/productos.html'
    iconoModificar.classList.add('btn', 'btn-primary', 'm-1')
    ...
    iconoBorrar.classList.add('btn', 'btn-danger', 'm-1');
